...
import com.example.adoption_and_breeding_module.service.impl.UserListener;
...
public class UserListenerTest {
    ...
    void setUp() {
        ...
        event = UserEvent.builder().userId(userId).username(username).email(email).latitude(0.0).longitude(0.0).build();
    }
