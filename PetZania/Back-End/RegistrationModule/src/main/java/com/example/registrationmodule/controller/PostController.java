...
import com.example.registrationmodule.service.impl.MediaService;
...
public class PostController {
    ...
    public ResponseEntity<PostResponseDTO> createPost(
        ...
        Post postWithMedia = mediaService.uploadAndSaveMedia(mediaFiles, postNoMedia);
    ...
    public ResponseEntity<Void> deletePost(@PathVariable UUID postId) {
        mediaService.deleteAllMediaForPost(postId);
